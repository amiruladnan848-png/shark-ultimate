        ...
        >
          ...
          <div className="glass rounded-3xl p-4 mt-4 professional-frame">
            ...
            <ul className="text-xs space-y-1.5 text-muted-foreground">
              <li className="flex justify-between gap-3"><span>Pipeline</span><span className="text-foreground text-right">Live Analyzer → Consensus → Booster → Shelter</span></li>
              <li className="flex justify-between gap-3"><span>Data feed</span><span className="text-foreground text-right">Deriv WS · Yahoo FX · Binance crypto · TradingView</span></li>
              <li className="flex justify-between gap-3"><span>Accuracy shelter</span><span className="text-foreground text-right">Auto re-scan below 88%</span></li>
